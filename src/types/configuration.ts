...
export type Schedule={id:string;name:string;checkInTime:string;checkOutTime:string;lateGraceMinutes:number;workingDays:number[];timezone?:string;isActive:boolean;createdAt?:string;updatedAt?:string};
