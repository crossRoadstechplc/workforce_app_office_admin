...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 z-30 hidden h-screen shrink-0 overflow-visible bg-slate-950 text-slate-300 transition-[width] duration-200 ease-out print:hidden lg:flex lg:flex-col",
